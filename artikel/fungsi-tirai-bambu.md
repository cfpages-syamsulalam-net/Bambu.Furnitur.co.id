---
article_id: BFU-13-03
title: "Privasi, Cahaya, dan Ventilasi pada Tirai Bambu"
slug: "fungsi-tirai-bambu"
...
date_modified: null
parent_topic: BFU-13
primary_intent: "Menentukan tingkat penutupan"
reader_community: "Furnitur.co.id"
reader_address: "Sobat Furnitur.co.id"
final_route: "/artikel/fungsi-tirai-bambu.html"
...
# Privasi, Cahaya, dan Ventilasi pada Tirai Bambu

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Privasi, Cahaya, dan Ventilasi pada Tirai Bambu”
...
- **Primary intent:** Menentukan tingkat penutupan
...
- **Scope boundary:** Fokus fungsi; bukan klaim termal tanpa pengujian.
- **Final public route:** `/artikel/fungsi-tirai-bambu.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Privasi, Cahaya, dan Ventilasi pada Tirai Bambu**.
...
- `BFU-13-01` → `/artikel/tirai-bambu-polos-vs-motif.html` — Panduan Memilih Tirai Bambu Polos atau Motif
...
- **Tie back to this article:** Keep the explanation specific to “Privasi, Cahaya, dan Ventilasi pada Tirai Bambu”.
