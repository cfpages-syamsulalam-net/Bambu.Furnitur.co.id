...
# Article Guide — bambu.furnitur.co.id
...
- Address the reader warmly as `Sobat Furnitur.co.id`, `Kawan Furnitur.co.id`, or `Teman Furnitur.co.id`. Use the exact opening salutation assigned inside the article file.
